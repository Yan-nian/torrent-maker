...
class TorrentMakerApp:
    ...
    def display_banner(self):
        ...
        print("                    🚨 重要通知 🚨")
        print("⚠️" + "=" * 58 + "⚠️")
        print("  此模块化版本已被弃用，建议使用高性能单文件版本！")
        print()
        print("  🚀 单文件版本优势：")
        print("    ⚡ 种子创建速度提升 30-50%")
        print("    🧠 智能算法优化，响应时间减少 40-60%")
        print("    💾 内存使用减少 20-30%")
        print("    🔧 完整的 v1.5.0 性能优化功能")
        print()
        print("  📁 使用方法：")
        print("    python torrent_maker.py")
        print()
        print("  ⏰ 此版本将在下个版本中移除")
        print("⚠️" + "=" * 58 + "⚠️")
        print()
        ...
        # 询问用户是否继续
        choice = input("是否继续使用此弃用版本？(y/N): ").strip().lower()
        if choice not in ['y', 'yes', '是']:
            print("\n👋 建议使用: python torrent_maker.py")
            print("感谢您的理解！")
            exit(0)

        print("\n⚠️  您选择继续使用弃用版本，功能可能不完整")
        print("=" * 60)
